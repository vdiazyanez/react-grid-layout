...
export function compact(
  ...
  console.log('compacting: ', layout, compactType, cols)
...
function resolveCompactionCollision(
  ...
  console.log('resolving compaction collision: ', layout, item, moveToCoord, axis)
...
export function compactItem(
  ...
  console.log('compacting item: ', compareWith, l, compactType, cols, fullLayout)
...
export function correctBounds(
  ...
  console.log('correcting bounds: ', layout, bounds)
...
export function moveElement(
  ...
  console.log('moving element: ', layout, l, x, y, isUserAction, preventCollision, compactType, cols)
...
export function moveElementAwayFromCollision(
  ...
  console.log('moving element away from collision: ', layout, collidesWith, itemToMove, isUserAction, compactType, cols)
  const compactH = compactType === "horizontal";
...
export function sortLayoutItems(
  ...
  console.log('sorting layout items: ', layout, compactyType)
...
export function synchronizeLayoutWithChildren(
  ...
  console.log('synchronizing layout with children', initialLayout, children, cols, compactType)
